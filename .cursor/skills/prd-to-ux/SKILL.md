---
name: prd-to-ux
description: Translates PRDs, feature specs, and product requirements into UX specifications for mockup tools (Google Stitch, Figma, or similar). Use when preparing for visual designs, wireframes, or component specs.
---
